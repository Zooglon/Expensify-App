...
export const startAddExpense = (expenseData = {}) => {
  ...
  return (dispatch, getState) => {
    // this const along with the getState arguement above gives us access to the uid
    ...
    // connects and saves to the database using the unique user id (uid)
...
// link to database, use set to remove. - look at firebase file.
